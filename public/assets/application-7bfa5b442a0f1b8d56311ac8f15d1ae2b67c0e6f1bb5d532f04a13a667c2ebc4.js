...
$(document).ready(function () {
  ...
  (function(){
    ...
    $.when(income.getIncomeFromDB(), expenditure.getExpenditureFromDB(), projection.getProjFromDB()).done(function(incomeData,expData, projData){
      ...
      var jsonObj = JSON.parse(JSON.stringify(projData[0]))
      var projMonthlyIncome = jsonObj[0].projected_monthly_income;
      var projMonthlyExpend = jsonObj[0].projected_monthly_expenditure;
      var projNetIncome = (projMonthlyIncome - projMonthlyExpend)
      console.log(projNetIncome);
      var projStartDate = jsonObj[0].start_date;
